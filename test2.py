...
def createRoad(length, direction):
    ...
    while loops < length:
        ...
        if direction == "North":
            ...
            mc.setBlocks(x+4, y-1, z+1, x-4, y-1, z+4, 43)
            mc.setBlocks(x+2, y-1, z+1, x-2, y-1, z+4, 35, 15)
            mc.setBlocks(x, y-1, z+2, x, y-1, z+3, 35, 4)
            z = z - 4
        elif direction == "East":
            ...
            mc.setBlocks(x+1, y-1, z+4, x+4, y-1, z-4, 43)
            mc.setBlocks(x+1, y-1, z+2, x+4, y-1, z-2, 35, 15)
            mc.setBlocks(x+2, y-1, z, x+3, y-1, z, 35, 4)
            x = x - 4
        else:
            exit(1)
...
def createIntersection():
    ...
    mc.setBlocks(x+2, y-1, z-4, x-2, y-1, z-4, 35, 0)
    mc.setBlocks(x+2, y-1, z+4, x-2, y-1, z+4, 35, 0)
